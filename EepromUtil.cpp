...
String EepromUtil::getStringFromRecord(NdefRecord record){
...
void EepromUtil::EEPROMWritelong(int address, long value){
...
long EepromUtil::EEPROMReadlong(long address){
